...
import { createContext, mergeProps, useContext, createEffect, untrack, batch, onMount, onCleanup, createSignal, Show, For } from 'solid-js';
...
const DragDropProvider = passedProps => {
  ...
  const sensorMove = coordinates => {
    ...
    setState("sensors", sensorId, "coordinates", "current", { ...coordinates
    });
  };
